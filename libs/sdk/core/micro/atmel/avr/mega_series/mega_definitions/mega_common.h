...
namespace core {
  ...
  namespace mega {
	...
	namespace i2c {
	  enum TWI_CONDITION
	  {
		START_TRASMISSION = setBitValue(1, TWINTx) | setBitValue(1, TWENx),
		START_CONDITION	  = setBitValue(1, TWINTx) | setBitValue(1, TWSTAx) | setBitValue(1, TWENx),
		STOP_CONDITION	  = setBitValue(1, TWINTx) | setBitValue(1, TWENx)  | setBitValue(1, TWSTOx),
		START_AND_ACK	  = setBitValue(1, TWINTx) | setBitValue(1, TWENx)  | setBitValue(1, TWEAx),
	  };
#if defined(__COMPILE__)
#if F_CPU == 16000000
	  /*
